                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <option   <?php if(old('type')==1  || old('type')=="" ): ?> selected="selected"  <?php endif; ?> value="1"> About Us</option>
                           ...
                           <option <?php if( (old('type')==4 and old('type')!="")): ?> selected="selected"  <?php endif; ?>   value="4"> How to use app</option>
                          </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/quran/resources/views/admin/pages/create.blade.php ENDPATH**/ ?>