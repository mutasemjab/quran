...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title card_title_center"> <?php echo e(__('messages.Add_New')); ?>  <?php echo e(__('messages.students')); ?> </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="email" id="name" class="form-control" value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-6">
                        <label for="class"> <?php echo e(__('messages.class')); ?></label>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/quran/resources/views/admin/students/create.blade.php ENDPATH**/ ?>